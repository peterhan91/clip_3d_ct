#!/bin/bash
#SBATCH --job-name=Merlin_Preprocess_Test
#SBATCH --output=merlin_test_preprocess_%j.out
#SBATCH --error=merlin_test_preprocess_%j.err
...
OUTPUT_PATH="/cbica/projects/CXR/data_p/merlin_test.h5"
...
echo "Merlin test preprocessing completed successfully!"
