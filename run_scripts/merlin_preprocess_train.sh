#!/bin/bash
#SBATCH --job-name=Merlin_Preprocess_Train
#SBATCH --output=merlin_train_preprocess_%j.out
#SBATCH --error=merlin_train_preprocess_%j.err
...
echo "Merlin train preprocessing completed successfully!"
