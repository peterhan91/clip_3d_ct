#!/bin/bash
#SBATCH --job-name=Merlin_Preprocess_Combined_Iso
#SBATCH --output=merlin_combined_iso_preprocess_%j.out
#SBATCH --error=merlin_combined_iso_preprocess_%j.err
...
OUTPUT_PATH="/cbica/projects/CXR/data_p/merlin_combined_iso_spacing.h5"
...
# Run preprocessing with combined Merlin dataset and isotropic spacing
cd $REPO_PATH
...
echo "Merlin combined preprocessing with isotropic spacing completed successfully!"
echo "Output saved to: $OUTPUT_PATH"
echo "This file contains all Merlin samples (train+valid+test) with isotropic spacing for CLIP training."