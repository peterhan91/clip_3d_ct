#!/bin/bash
#SBATCH --job-name=Merlin_Preprocess_Valid_Iso
#SBATCH --output=merlin_valid_iso_preprocess_%j.out
#SBATCH --error=merlin_valid_iso_preprocess_%j.err
...
OUTPUT_PATH="/cbica/projects/CXR/data_p/merlin_valid_iso_spacing.h5"
...
echo "Merlin validation preprocessing (isotropic spacing) completed successfully!"
