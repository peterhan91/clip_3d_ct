#!/bin/bash
#SBATCH --job-name=Inspect_Preprocess_Valid_Iso
#SBATCH --output=inspect_valid_iso_preprocess_%j.out
#SBATCH --error=inspect_valid_iso_preprocess_%j.err
#SBATCH --time=4:00:00
#SBATCH --ntasks=1
...
OUTPUT_PATH="/cbica/projects/CXR/data_p/inspect_valid_iso_spacing.h5"
...
echo "Inspect validation preprocessing (isotropic spacing) completed successfully!"
