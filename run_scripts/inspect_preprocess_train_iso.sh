#!/bin/bash
#SBATCH --job-name=Inspect_Preprocess_Train_Iso
#SBATCH --output=inspect_train_iso_preprocess_%j.out
#SBATCH --error=inspect_train_iso_preprocess_%j.err
...
OUTPUT_PATH="/cbica/projects/CXR/data_p/inspect_train_iso_spacing.h5"
...
echo "Inspect train preprocessing (isotropic spacing) completed successfully!"
